...
function HeadContent2(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(import_jsx_runtime17.Fragment, { children: (hydrated ? tags.filter((tag) => tag.tag !== "link" || tag.attrs?.[DEV_STYLES_ATTR] !== true) : tags).map((tag) => (0, import_react12.createElement)(Asset, {
    ...tag,
